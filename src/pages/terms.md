...
- "Platform" means the Competition website and associated services at poker.cmudsc.com and poker-dash.cmudsc.com
...
- "Time Bank" means the total allowed computation time (7 minutes) per Bot per Match
...
CMU shall have the right to modify these Competition Rules at any time, which modification shall be effective immediately upon posting. Accordingly, we suggest that you review our Competition Rules when you use the Services to stay informed. If you disagree with the changes to these Competition Rules, you should discontinue your participation in the Competition. To make your periodic review more convenient, we will post a date at the top of this page.

## 3. Privacy and Data Collection
Please refer to our Privacy Statement at https://poker.cmudsc.com/privacy for details on how we collect, use and disclose information. The Privacy Statement is incorporated by reference into these Competition Rules.
...
1. International students are eligible to participate and win prizes provided they:
   - Are enrolled at a whitelisted U.S. university
   - Possess or have access to a valid U.S. bank account
   - Complete all required tax documentation (W-8BEN)
   - Comply with all U.S. tax regulations and withholding requirements
...
- Teams must register through https://poker-dash.cmudsc.com using university email addresses
...
- Must create and maintain a valid account on https://poker-dash.cmudsc.com
...
#### Team Composition
- Each team must consist of either one (1) or two (2) eligible Participants
- Team members may be from different whitelisted universities
- Each Participant may be a member of only one team during the Competition

#### Team Registration
- Teams must register through https://poker-dash.cmudsc.com
- All team members must create individual accounts using their university email addresses
- One team member will initiate team creation and invite their teammate through the platform
- Both team members must accept and confirm team formation before participating
...
- Finals Structure:
  - Two-day development period for teams to modify and improve their bots
  - Round-robin tournament wherein each team shall compete against all other attending teams
  - Teams shall be ranked by overall win rate
...
- All necessary files must be submitted through https://poker-dash.cmudsc.com
- Detailed API documentation is available at https://poker-dash.cmudsc.com/docs
...
1. Intercollegiate Competition Prizes
   ...
   - Prize distribution:
     ...
     - Second Place: $25,000
     - Third Place: $15,000
     - Fourth through Tenth Place: $1,250 each
     - Eleventh and Twelfth Place: No monetary prize
...
1. Online Competition Phase
   - Winners notified within 48 hours of competition end
   - Documentation requirements sent within 72 hours
   - Documentation must be completed within 7 days
   - Prize distribution within 30 days of documentation completion

2. Finals Phase
   - Winners announced at conclusion of Finals event
   - Documentation requirements provided on-site
   - Documentation must be completed within 7 days
   - Prize distribution within 30 days of documentation completion
...
2. Team Submissions
   - Teams retain ownership of their bot code but grant CMU and Jump Trading a perpetual, irrevocable, worldwide, royalty-free license to:
     - Use, modify, and distribute such code for Competition-related purposes
     - Analyze and publish results and findings based on such code
     - Use team names and Competition results for promotional purposes
...
1. These Rules shall be governed by and construed in accordance with the laws of the Commonwealth of Pennsylvania
2. Any dispute arising from or relating to the Competition shall be:
   - Subject to the exclusive jurisdiction of the courts of Allegheny County, Pennsylvania
   - Limited to individual actions (no class actions)
3. Participants expressly waive:
   - Any objection to such jurisdiction and venue
   - Any right to seek another forum
...
1. If any provision of these Rules is found invalid or unenforceable:
   - The remaining provisions shall remain in full force and effect
   - The invalid provision shall be reformed to fulfill its intended purpose
2. Sections regarding intellectual property, liability, and dispute resolution:
   - Shall survive any termination or expiration of these Rules
   - Continue to bind participants indefinitely

### Modification of Rules
1. CMU reserves the right to:
   - Modify these Rules at any time
   - Make final determinations regarding rule interpretation
   - Resolve any disputes regarding the Competition
2. Changes to these Rules:
   - Will be effective upon posting to the Platform
   - Will not apply retroactively to actions taken in good faith
   - May require acknowledgment for continued participation

### Complete Agreement
1. These Rules, together with the Terms of Use and Privacy Statement:
   - Constitute the entire agreement regarding the Competition
   - Supersede all prior agreements and understandings
   - May not be modified except in writing by CMU
2. No waiver of any term shall be deemed:
   - A further or continuing waiver
